  ...
  return (
    <aside className="profile-card">
      ...
      <div className="profile-bio">
        I am a computer science enthusiast, fascinated by how computation and finance intertwine. My interests span verifiable delay functions, zero-knowledge proofs, decentralized finance and exchanges, and the practical applications of automated market makers. I'm currently exploring how high-performance computing—multi-core processors and GPUs—can transform financial markets, from order execution to options pricing and hedge fund strategies.
      </div>
